...
const testimonials: Testimonial[] = [
  {
    ...
    content: 'Rloko has completely transformed my wardrobe! The quality is exceptional and the designs are timeless. Every piece I own from them gets compliments.',
    rating: 5,
  ...
  },
  {
    ...
    role: 'Designer',
    content: 'I love how Rloko combines luxury with sustainability. Beautiful pieces that make you feel confident and stylish. A must-have brand!',
    rating: 5,
  ...
  },
  {
    ...
    content: 'The perfect blend of modern design and classic elegance. Every purchase has exceeded my expectations. Rloko is my go-to for premium fashion.',
    rating: 5,
